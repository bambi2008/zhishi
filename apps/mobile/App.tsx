...
function PersonalizedInterpretationPanel({
  ...
  return <View style={styles.interpretationWrap}>
    <View style={[styles.card, styles.interpretationRequestCard]}>
      ...
      <TextInput value={question} onChangeText={setQuestion} maxLength={300} multiline placeholder="例如：最近工作节奏变化，我该观察哪些真实信号？请不要填写姓名、联系方式等敏感信息。" placeholderTextColor="#A9ADA4" style={styles.interpretationQuestion} />
